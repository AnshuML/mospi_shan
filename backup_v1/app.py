...
print(f"[INFO] Generating embeddings for {len(names)} names...")
emb_names = bi_encoder.encode(names, convert_to_numpy=True, show_progress_bar=True)
print("[INFO] Name embeddings done. Generating embeddings for descriptions...")
emb_descs = bi_encoder.encode(descs, convert_to_numpy=True, show_progress_bar=True)
print("[INFO] Combining embeddings...")
embeddings = (0.4 * emb_names + 0.6 * emb_descs)
